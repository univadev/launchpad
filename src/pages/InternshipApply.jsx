    ...
    return (
      <div className="pt-14 min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-zinc-300 font-medium mb-4">Internship not found.</p>
    ...
    return (
      <div className="pt-14 min-h-screen flex items-center justify-center">
        <div className="max-w-md w-full px-4 text-center flex flex-col items-center gap-5">
          <div className="w-16 h-16 rounded-full bg-accent-600/20 border border-accent-600/30 flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400 leading-relaxed">
              We'll review your application and reach out if you're shortlisted for an intro to {internship.company}.
            </p>
          </div>
          <Link to="/internships" className="btn-primary">Back to Internships</Link>
        </div>
    ...
    <div className="pt-14 min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <p className="text-sm text-zinc-500 mb-0.5">{internship.company}</p>
            <h1 className="text-xl font-bold text-white">{internship.role}</h1>
          </div>
        </div>

        {submitError && (
          <div className="flex items-center gap-2.5 p-3 mb-6 bg-red-900/30 border border-red-800/50 rounded-lg text-red-300 text-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Field label="Transcript / resume link" required
              hint="Link to a PDF — Google Drive, Dropbox, or similar."
          ...
          {/* ── Actions ── */}
          <div className="flex items-center justify-between pt-2 border-t border-white/10 pb-6">
            <Link to="/internships" className="btn-ghost">Cancel</Link>
